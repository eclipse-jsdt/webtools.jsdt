...
public interface MixedContentStatusValue {
   ...
   */
  org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.security.SecurityStateEnum ranInsecureContentStyle();

  /**
   Security state representing a page that displayed insecure content.
   */
  org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.security.SecurityStateEnum displayedInsecureContentStyle();
