...
public interface PromiseDetailsValue {
   ...
   */
  @org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonOptionalField
  java.util.List<org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.console.CallFrameValue>/*See org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.console.StackTraceTypedef*/ creationStack();

  /**
   JavaScript asynchronous stack trace on promise creation, if available.
   */
  @org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonOptionalField
  org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.console.AsyncStackTraceValue asyncCreationStack();

  /**
   JavaScript stack trace on promise settlement.
   */
  @org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonOptionalField
  java.util.List<org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.console.CallFrameValue>/*See org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.console.StackTraceTypedef*/ settlementStack();

  /**
   JavaScript asynchronous stack trace on promise settlement, if available.
   */
  @org.eclipse.wst.jsdt.chromium.internal.protocolparser.JsonOptionalField
  org.eclipse.wst.jsdt.chromium.internal.wip.protocol.input.console.AsyncStackTraceValue asyncSettlementStack();
