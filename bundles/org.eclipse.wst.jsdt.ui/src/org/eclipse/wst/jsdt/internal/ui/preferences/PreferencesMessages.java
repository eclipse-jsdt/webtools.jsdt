...
public final class PreferencesMessages extends NLS {
	...
	public static String JavaEditorPreferencePage_templateLiteral;
...
//	public static String MembersOrderPreferencePage_fields_label;
	...
	public static String AbstractRuntimeInstallPage_MissingRuntimeName_Message;
	public static String AbstractRuntimeInstallPage_DuplicateName_Error;
	public static String AbstractRuntimeInstallPage_InvalidFileName_Error;
	public static String AddRuntimeInstallWizard_WindowTitle;
	public static String EditRuntimeInstallWizard_WindowTitle;
	public static String InstalledJSRuntimesBlock_DefaultRuntime_Label;
	public static String InstalledJSRuntimesBlock_ContributedRuntime_Label;
	public static String InstalledJSRuntimesBlock_InstalledRuntimes_Label;
	public static String InstalledJSRuntimesBlock_NameColumn_Label;
	public static String InstalledJSRuntimesBlock_LocationColumn_Label;
	public static String InstalledJSRuntimesBlock_AddButton_Label;
	public static String InstalledJSRuntimesBlock_EditButton_Label;
	public static String InstalledJSRuntimesBlock_DuplicateButton_Label;
	public static String InstalledJSRuntimesBlock_RemoveButton_Label;
	public static String JSRuntimesPreferencePage_JSRuntimes_Title;
	public static String JSRuntimesPreferencePage_NoRuntimes_Error;
	public static String JSRuntimesPreferencePage_NoDefaultRuntime_Error;
	public static String JSRuntimesPreferencePage_UnsavedChanges_Message;
	public static String JSRuntimesPreferencePage_ApplyButton_Label;
	public static String JSRuntimesPreferencePage_DiscardButton_Label;
	public static String JSRuntimesPreferencePage_ApplyLaterButton_Label;
	public static String RuntimeDetailsDialog_RuntimeDetails_Title;
	public static String RuntimeDetailsDialog_TypeField_Label;
	public static String RuntimeDetailsDialog_NameField_Label;
	public static String RuntimeDetailsDialog_LocationField_Label;
	public static String RuntimeDetailsDialog_ArgumentsField_Label;
	public static String StandardRuntimeInstallPage_PageTitle;
	public static String StandardRuntimeInstallPage_RuntimeLocationField_Label;
	public static String StandardRuntimeInstallPage_RuntimeLocationFileButton_Label;
	public static String StandardRuntimeInstallPage_RuntimeLocationNameField_Label;
	public static String StandardRuntimeInstallPage_RuntimeArgumentsField_Label;
	public static String StandardRuntimeInstallPage_RuntimeLocationVariablesButton_Label;
	public static String StandardRuntimeInstallPage_RuntimeEmptyLocation_Error;
