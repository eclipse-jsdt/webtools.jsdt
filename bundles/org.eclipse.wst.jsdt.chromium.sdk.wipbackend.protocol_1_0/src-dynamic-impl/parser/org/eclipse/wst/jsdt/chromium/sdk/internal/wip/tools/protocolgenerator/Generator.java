...
package org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator;
...
import org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.EnumValueCondition;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.ArrayItemType;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.Command;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.Domain;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.Event;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.ObjectProperty;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.Parameter;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.tools.protocolgenerator.WipMetamodel.StandaloneType;

/**
 * Read metamodel and generates set of files with Java classes/interfaces for the protocol.
 */
class Generator {
  private static final String ROOT_PACKAGE = "org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol";
  ...
  private class DomainGenerator {
    ...
    private void generateCommandParams(Command command, boolean hasResponse) throws IOException {
      ...
      baseTypeBuilder.append("org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.output.");
      if (hasResponse) {
      ...
      additionalMemberBuilder.append("  public static final String METHOD_NAME = " +
          "org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.BasicConstants.Domain." +
      ...
      if (hasResponse) {
        ...
        additionalMemberBuilder.append(
            ...
            "org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.input.WipCommandResponse.Data data, " +
            "org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.input." +
            PARSER_ROOT_INTERFACE_NAME + " parser) " +
            "throws org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonProtocolParseException {\n");
    ...
    StandaloneTypeBinding createStandaloneObjectInputTypeBinding(final StandaloneType type,
      ...
      return new StandaloneTypeBinding() {
        ...
        public void generate() throws IOException {
          ...
          writer.write("@org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonType\n");
    ...
    private void generateEvenData(Event event) throws IOException {
      ...
      String eventTypeMemberText =
          "  public static final org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.input.WipEventType<" +
          fullName +
          "> TYPE\n      = new org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.input.WipEventType<" +
          fullName +
      ...
      class InputMemberScope extends MemberScope {
        ...
        public String generateNestedObject(String description,
          ...
          if (propertyList == null) {
            builder.append("  @org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonType(" +
                "allowsOtherProperties=true)\n");
            builder.append("  public interface " + objectName +
                " extends org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonObjectBased {\n");
            builder.append("  }\n");
          } else {
            builder.append("  @org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonType\n");
            builder.append("  public interface " + objectName + " {\n");
  ...
  private static class QualifiedTypeData {
    ...
    void writeAnnotations(Appendable appendable, String indent) throws IOException {
      if (isOptional()) {
        appendable.append(indent + "@org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonOptionalField\n");
      }
      if (isNullable()) {
        appendable.append(indent + "@org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonNullable\n");
      }
    }
  }
  ...
  private void generateParserRoot(List<ParserRootInterfaceItem> parserRootInterfaceItems)
    ...
    writer.write("@org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonParserRoot\n");
  ...
  private static class ParserRootInterfaceItem implements Comparable<ParserRootInterfaceItem> {
    ...
    void writeCode(Writer writer) throws IOException {
      writer.write("  @org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonParseMethod\n");
  ...
  private String generateMethodNameSubstitute(String originalName, Appendable output)
    ...
    output.append("  @org.eclipse.wst.jsdt.chromium.sdk.internal.protocolparser.JsonField(jsonLiteralName=\"" +
        originalName + "\")\n");
