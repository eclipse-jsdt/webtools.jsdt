...
import org.eclipse.wst.jsdt.chromium.sdk.BrowserTab;
...
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.output.debugger.PauseParams;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.output.debugger.SetBreakpointsActiveParams;
import org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.output.debugger.SetPauseOnExceptionsParams;
...
import org.eclipse.wst.jsdt.chromium.sdk.util.SignalRelay.AlreadySignalledException;
import org.eclipse.wst.jsdt.chromium.sdk.wip.EvaluateToMappingExtension;
import org.eclipse.wst.jsdt.chromium.sdk.wip.PermanentRemoteValueMapping;
import org.eclipse.wst.jsdt.chromium.sdk.wip.WipBrowser;
import org.eclipse.wst.jsdt.chromium.sdk.wip.WipBrowserTab;
import org.eclipse.wst.jsdt.chromium.sdk.wip.WipJavascriptVm;
...
public class WipTabImpl implements WipBrowserTab, WipJavascriptVm {
  ...
  private void init() {
    ...
    commandProcessor.send(
        new org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.output.debugger.EnableParams(),
        null, syncCallback);

    commandProcessor.send(
        new org.eclipse.wst.jsdt.chromium.sdk.internal.wip.protocol.output.page.EnableParams(),
        null, null);
