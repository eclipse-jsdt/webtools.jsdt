...
public class JavaElement extends ASTAttribute {
	...
	private static final long LABEL_OPTIONS=
		JavaScriptElementLabels.F_APP_TYPE_SIGNATURE | JavaScriptElementLabels.M_PARAMETER_TYPES | 
		JavaScriptElementLabels.M_APP_RETURNTYPE | JavaScriptElementLabels.ALL_FULLY_QUALIFIED |
		JavaScriptElementLabels.T_TYPE_PARAMETERS |JavaScriptElementLabels.USE_RESOLVED;
	
	private final IJavaScriptElement fJavaElement;
	private final Object fParent;

	public JavaElement(Object parent, IJavaScriptElement javaElement) {
		fParent= parent;
	...
	public String getLabel() {
		if (fJavaElement == null) {
			...
			return "> " + classname.substring(classname.lastIndexOf('.') + 1) + ": " //$NON-NLS-1$ //$NON-NLS-2$
					+ JavaScriptElementLabels.getElementLabel(fJavaElement, LABEL_OPTIONS)
